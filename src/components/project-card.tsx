    ...
    <Link href={`/projects/${project.slug}`} passHref>
        ...
        <div className="relative z-20 flex h-full flex-col justify-between p-6 text-white">
            ...
            <div className="flex flex-col items-center justify-center text-center">
                <Button variant="outline" className="bg-white/20 border-white/30 text-white backdrop-blur-sm transition-all group-hover:bg-white group-hover:text-primary scale-90 group-hover:scale-100 opacity-0 group-hover:opacity-100 pointer-events-none">
                    See Project
